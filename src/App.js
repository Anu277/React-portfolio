        ...
        <div className='intro flex flex-wrap justify-around lg:min-w-4xl m-auto my-40' data-aos="fade-up">
          <div className='intro-mat flex flex-col archivo max-w-xl m-auto'>
            ...
            <section className='socialMedia w-auto flex items-center gap-3 border-t mt-1 p-4'>
              ...
              <a href='https://drive.google.com/file/d/1iUPFG4jfzz1wPXB6lADynywn56Jorjy_/view?usp=sharing'><button type="button" className=" text-black hover:text-white bg-white hover:bg-zinc-900 p-2 rounded-full border-2 border-zinc-100">Resume</button></a>
            </section>
          </div>
